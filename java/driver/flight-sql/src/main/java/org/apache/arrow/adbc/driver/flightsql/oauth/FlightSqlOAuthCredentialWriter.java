    ...
    try {
      final OAuthTokenProviders.TokenExchangeBuilder builder =
          OAuthTokenProviders.tokenExchange()
              ...
              .subjectTokenType(
                  requireOption(
                      parameters, FlightSqlConnectionProperties.OAUTH_EXCHANGE_SUBJECT_TOKEN_TYPE));
      ...
      final String clientSecret = FlightSqlConnectionProperties.OAUTH_CLIENT_SECRET.get(parameters);
